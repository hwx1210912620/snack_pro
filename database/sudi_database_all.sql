...
insert  into `sudi_address`(`addressId`,`userId`,`defaulted`,`address`) values (1,1,0,'厦门市集美大学银江路183号'),(2,1,0,'厦门市思明区思明南路40号1107室'),(3,1,0,'厦门市集美大学诚毅集友3号楼209号'),(4,1,1,'厦门市集美大学六社区五组团113'),(5,15,0,'测试地址1');
...
insert  into `sudi_comment`(`commentId`,`orderDetailId`,`userId`,`commentScore`,`commentContent`,`commentTime`) values (2,47,1,'3.50','还不错','2020-12-08 13:57:03'),(3,46,1,'4.00','还不错','2020-12-08 14:04:20'),(4,48,1,'5.00','好吃','2020-12-08 14:12:46'),(5,47,1,'5.00','好吃\n','2020-12-11 11:16:30'),(6,63,15,'1.50','份量严重不足，就这么小小一份不够吃！','2020-12-17 18:35:12'),(7,65,15,'5.00','肥宅快乐水无敌！！！','2020-12-17 18:35:52'),(8,67,1,'3.50','好不错 下饭','2020-12-23 15:15:04');
...
insert  into `sudi_foodattr`(`foodattrId`,`foodattrName`) values (1,'规格'),(2,'口味'),(3,'温度'),(4,'甜度'),(5,'份量'),(6,'主食'),(7,'酱料'),(8,'包装'),(9,'加料'),(10,'小菜'),(11,'小食'),(12,'其他'),(13,'测试test');
...
insert  into `sudi_foodvalue`(`foodvalueId`,`foodattrId`,`foodId`,`foodvalueName`) values (22,1,14,'大份'),(23,1,14,'中份'),(24,1,14,'小份'),(25,1,14,'test'),(27,7,15,'番茄酱'),(28,7,15,'甜辣酱'),(29,7,15,'黑胡椒酱'),(30,7,15,'千岛酱'),(31,7,15,'猪扒测试'),(32,1,16,'牛肉丁'),(33,1,16,'猪肉丁'),(34,1,16,'火腿肠'),(35,1,17,'辣'),(36,1,17,'不辣'),(37,5,18,'大份'),(38,5,18,'中份'),(39,5,18,'小份'),(40,5,19,'大份'),(41,5,19,'中份'),(42,5,19,'小份'),(43,1,20,'大份'),(44,1,20,'小份'),(45,1,22,'大份'),(46,1,22,'中份'),(47,1,22,'小份'),(48,2,23,'孜然味'),(49,2,23,'微辣'),(50,2,23,'香辣'),(51,1,24,'大杯'),(52,1,24,'中杯'),(53,1,24,'小杯'),(54,1,24,'听装'),(55,1,25,'大份'),(56,1,25,'中份'),(57,1,25,'小份'),(58,5,26,'大份'),(59,5,26,'中份'),(60,5,26,'小份'),(61,3,27,'冰'),(62,3,27,'常温'),(63,3,28,'常温'),(64,3,28,'加冰'),(65,3,28,'wenre');
...
insert  into `sudi_role_menu`(`roleId`,`menuId`) values (5,1),(5,2),(5,3),(5,4),(5,6),(5,5),(5,10),(5,11),(5,12),(5,13),(5,7),(5,15),(5,16),(5,17),(5,20),(5,24),(5,25),(5,8),(5,9),(5,14),(5,18),(5,19),(5,21),(5,22),(5,23),(1,8),(1,9),(1,14),(1,18),(1,19),(2,8),(2,9),(2,21),(2,22),(2,23),(3,6),(3,5),(3,10),(3,11),(3,12),(3,13),(3,7),(3,15),(3,16),(3,17),(3,20),(3,24),(3,25),(3,8),(3,9),(4,1),(4,2),(4,3),(4,4),(4,8),(4,9),(4,14),(4,18),(4,19);
...
insert  into `sudi_user_role`(`userId`,`roleId`) values (11,5),(1,1),(1,5),(5,2),(7,2),(8,2),(14,1),(3,1),(3,3),(4,1),(4,4),(2,1),(14,2),(2,2),(15,1),(15,5),(15,2),(9,2),(12,2);
...
/*Table structure for table `sudi_view_food_order` */

DROP TABLE IF EXISTS `sudi_view_food_order`;

/*!50001 DROP VIEW IF EXISTS `sudi_view_food_order` */;
/*!50001 DROP TABLE IF EXISTS `sudi_view_food_order` */;

/*!50001 CREATE TABLE  `sudi_view_food_order`(
 `orderdetailId` bigint(20) ,
 `orderId` varchar(20) ,
 `amount` int(11) ,
 `itemPrice` decimal(5,2) ,
...
/*View structure for view sudi_view_food_order */

/*!50001 DROP TABLE IF EXISTS `sudi_view_food_order` */;
/*!50001 DROP VIEW IF EXISTS `sudi_view_food_order` */;

/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `sudi_view_food_order` AS select `od`.`orderdetailId` AS `orderdetailId`,`od`.`orderId` AS `orderId`,`od`.`amount` AS `amount`,`od`.`itemPrice` AS `itemPrice`,`od`.`comment` AS `comment`,`od`.`skuId` AS `skuId`,`od`.`skuName` AS `skuName`,`od`.`skuPrice` AS `skuPrice`,`od`.`skuSale` AS `skuSale`,`od`.`skuStock` AS `skuStock`,`od`.`foodId` AS `foodId`,`od`.`foodName` AS `foodName`,`od`.`foodTypeId` AS `foodTypeId`,`od`.`foodIngredient` AS `foodIngredient`,`od`.`foodVegon` AS `foodVegon`,`od`.`foodCookWay` AS `foodCookWay`,`od`.`foodFaultCount` AS `foodFaultCount`,`od`.`foodDesc` AS `foodDesc`,`od`.`foodImage` AS `foodImage`,`od`.`foodSaleCount` AS `foodSaleCount`,`od`.`foodViewCount` AS `foodViewCount`,`od`.`foodScore` AS `foodScore`,`od`.`commentCount` AS `commentCount`,`od`.`recommend` AS `recommend`,`od`.`hotSale` AS `hotSale`,`od`.`foodStatus` AS `foodStatus`,`od`.`lastModifyBy` AS `lastModifyBy`,`od`.`lastModifyTime` AS `lastModifyTime`,`od`.`typeId` AS `typeId`,`od`.`typeName` AS `typeName`,`od`.`typeDesc` AS `typeDesc`,`od`.`typeStatus` AS `typeStatus`,`o`.`orderTime` AS `orderTime` from (`sudi_view_orderdetail` `od` left join `sudi_order` `o` on((`od`.`orderId` = `o`.`orderId`))) */;
